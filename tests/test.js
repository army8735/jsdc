...
describe('es6', function() {
  ...
  describe('generator function', function() {
    ...
    it('in whilestmt', function() {
      ...
      Jsdc.reset();
      var res = Jsdc.parse(s);
      expect(res).to.eql('var a=function(){var _0=0;return function(){return{next:_1}};var _2;function _1(_3){while(1){switch(_0){case 0:_0=(_2=i++<5)?1:2;break;case 1:_0=3;return{value:i,done:_2&&1};case 3:_0=0;break;case 2:_0=-1;default:return{done:true}}}}}();');
    });
    ...
    it('in dowhilestmt', function() {
      ...
      Jsdc.reset();
      var res = Jsdc.parse(s);
      expect(res).to.eql('var a=function(){var _0=0;return function(){return{next:_1}};var _2;function _1(_3){while(1){switch(_0){case 0:case 1:_0=3;return{value:i,done:_2&&1};case 3:_0=2;break;case 2:_0=(_2=i++<5)?1:4;break;case 4:_0=-1;default:return{done:true}}}}}();');
    });
